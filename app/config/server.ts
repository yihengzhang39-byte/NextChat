...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      IDENTITY_VERIFY_MOCK_AGE_PROFILE?: string;
      IDENTITY_VERIFY_MOCK_BIRTH_DATE?: string;
      IDENTITY_VERIFY_MOCK_TEST_ID_NUMBER?: string;
...
export const getServerSideConfig = () => {
  ...
  let defaultModel =
    process.env.DEFAULT_MODEL ?? PRODUCT_DEFAULT_MODEL_WITH_PROVIDER;
  let visionModels = process.env.VISION_MODELS ?? PRODUCT_DEFAULT_MODEL;
